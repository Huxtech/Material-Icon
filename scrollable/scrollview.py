...
from kivy_dev_client.components.scrollable.sv import ScrollView
...
class HuxScrollView(DeclarativeBehavior, BackgroundColorBehavior, ScrollView):
    """
